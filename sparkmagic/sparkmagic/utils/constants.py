...
SESSION_KIND_PYSPARK = "pyspark-notsupported"
SESSION_KIND_PYSPARK3 = "pyspark"
SESSION_KIND_SPARKR = "sparkr"
SESSION_KINDS_SUPPORTED = [SESSION_KIND_SPARK, SESSION_KIND_PYSPARK3, SESSION_KIND_SPARKR]
